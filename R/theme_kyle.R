...
#' @param title_pos String. Either "center" or "left" to align title and subtitle center of left respectively
#' @param axis_title_pos String. Either "center" or "left" to align title and subtitle center or left/top respectively
#' @param slides Logical. if TRUE, use background #ECECEC or not. Default is FALSE.
#' @param has_subtitle Logical. Adjusts margins when subtitle is used. Default is FALSE.
